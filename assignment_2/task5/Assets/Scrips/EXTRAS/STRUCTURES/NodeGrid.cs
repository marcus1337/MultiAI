...
namespace Assets.Scrips.EXTRAS.STRUCTURES
{
    ...
    public class NodeGrid
    {
        ...
        public NodeGrid(TerrainManager manager)
        {
            ...
            width = manager.myInfo.x_N * 5;
            height = manager.myInfo.z_N * 5;
        ...
        public void clearBaddies()
        {
            avoid = new LinkedList<Point>();
        }
        LinkedList<Point> avoid = null;

        public void setBaddies(LinkedList<Point> bads)
        {
            avoid = bads;
        }
