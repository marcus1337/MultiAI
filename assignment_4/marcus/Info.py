...
class Info(object):
    ...
    evochamberStart = False
    roachwarrenStart = False
    evochamberDone = False
    roachwarrenDone = False
    ...
    def update(self):
        ...
        self.numOverlordEggs = self.bot.already_pending(sc2.UnitTypeId.OVERLORD, True)
